...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[LE]{\small\textit{4. Tail Inequalities}}
...
\addcontentsline{toc}{chapter}{4. Tail Inequalities}
\markboth{4.\ Tail Inequalities}{4.\ Tail Inequalities}
...
its bound is often too loose for practical use. In this chapter, we develop
...
$A$ satisfies $|\lambda_{\max}(A) - cp| \leq O(\sqrt{cp})$ with high
