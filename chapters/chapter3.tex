...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[LE]{\small\textit{3. Game-Theoretic Techniques}}
...
\chapter*{3 Game-Theoretic Techniques}
\addcontentsline{toc}{chapter}{3 Game-Theoretic Techniques}
\markboth{3 Game-Theoretic Techniques}{Randomized Algorithms}
