...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[LE]{\small\textit{7. Algebraic Techniques}}
...
\addcontentsline{toc}{chapter}{7 Algebraic Techniques}
\markboth{7 Algebraic Techniques}{Randomized Algorithms}
