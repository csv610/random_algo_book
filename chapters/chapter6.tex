...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[LE]{\small\textit{6. Markov Chains and Random Walks}}
...
\addcontentsline{toc}{chapter}{6. Markov Chains and Random Walks}
\markboth{6.\ Markov Chains and Random Walks}{6.\ Markov Chains and Random Walks}
...
\]
By a standard drift argument (see Chapter~4), the expected time to reach
