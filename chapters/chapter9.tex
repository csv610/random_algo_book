...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[LE]{\small\textit{9. Geometric Algorithms and LP}}
...
\chapter*{9 Geometric Algorithms and Linear Programming}
\addcontentsline{toc}{chapter}{9 Geometric Algorithms and Linear Programming}
\markboth{9 Geometric Algorithms and Linear Programming}{Randomized Algorithms}
