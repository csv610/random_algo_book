...
void demonstrate_crypto() {
    ...
    println("--- RSA Encryption/Decryption ---");
    {
        ...
        println("  p = {}, q = {}, n = {}, phi(n) = {}", p, q, n, (p - 1) * (q - 1));
        println("  Public key:  (e={}, n={})", pub_e, n);
        println("  Private key: (d={}, n={})", priv_d, n);
        ...
        println("  Roundtrip OK: {}", plain == msg ? "YES" : "NO");
