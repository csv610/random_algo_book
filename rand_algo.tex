...
\begin{enumerate}
\item Assign independent random values from a sufficiently large finite field
to the nonzero entries of the Tutte/determinant polynomial.
...
\item By the determinant-polynomial criterion and Schwartz--Zippel, the
determinant is nonzero with high probability when a perfect matching exists,
and is identically zero when none exists.  This establishes randomized
parallel existence testing; recovering the matching requires the standard
additional self-reduction with repeated determinant tests.
