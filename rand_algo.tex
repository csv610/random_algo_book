...
Deployed in **Google BigQuery, Elasticsearch, Amazon Redshift, and Redis**. It is used to 
...
A core component of **Vector Databases (Pinecone, Milvus, Qdrant)** and recommendation 
