...
all: build/chapter1 build/chapter2 build/chapter3 build/chapter4 build/chapter5 build/chapter6 build/chapter7 build/chapter8 build/chapter9 build/chapter10 build/chapter11 build/chapter12 build/chapter13 build/chapter14
...
$(BUILDDIR)/chapter2: src/chapter2/main.cpp src/chapter2/*.h | $(BUILDDIR)
	$(CXX) $(CXXFLAGS) -Isrc/chapter2 -o $@ $<
...
$(BUILDDIR)/chapter13: src/chapter13/main.cpp src/chapter13/*.h | $(BUILDDIR)
	$(CXX) $(CXXFLAGS) -Isrc/chapter13 -Isrc/chapter10 -o $@ $<

$(BUILDDIR)/chapter14: src/chapter14/main.cpp src/chapter14/*.h | $(BUILDDIR)
	$(CXX) $(CXXFLAGS) -Isrc/chapter14 -o $@ $<
